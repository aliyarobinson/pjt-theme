...
<link rel="icon" type="image/png" href="<?php print IMAGES; ?>/favicon.png" />
<?php wp_head(); ?>
</head>
<?php 
    global $post;
...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'pjt' ); ?></a>
	    ...
	    <div class="wrapper">
		  ...
		  if ( is_front_page() && is_home() ) : ?>
		      <h1 class="logo-wrapper">
		        ...
		        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="nav-trigger" rel="home">
		          <img src="<?php print IMAGES; ?>/header-logo.png" alt="logo">
		        </a>
		      </h1>
			<?php else : ?>
	      ...
	      <button class="menu-btn hide-copy" aria-controls="primary-menu" aria-expanded="false">
	        <?php esc_html_e( 'Primary Menu', 'pjt' ); ?>
	      ...
	      <div class="header-top-bar">
	        <a href="<?php print THEMEROOT; ?>/support-us/" class="btn support-btn light">Support Us</a>
	        <div class="social">
